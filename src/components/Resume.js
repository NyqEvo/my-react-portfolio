...
function Resume() {
    return (
        <div className='container-sm text-center border border-light border-4 rounded mx-5 py-5' id='resume'>
            <img src={resume} alt='pic of resume' className='img-fluid text-center object-fit-fill' />
