...
const Projects = () => {
    ...
    return (
        <div className="project-container container-md">
            {/* <h2 className='border-bottom border-light border-2'>Projects</h2>
            ...
            <p className='my-2'>Task Sandwich is a project managment site with a reward system included. Users can earn reward credits to spend however they agree on spending them for their own real life rewards. Using Apollo GraphQL and MongoDb, we were able to successfully store data (with encryption for passwords) and send data to front end with a viariety of typeDefs and resolvers.</p>
            ...
            <p className='my-2'>This is a project done to demonstrate my ability to both create a functioning database as well as retrieve, update, add, and delete information in the database from the front end.</p>
        </div>
    )
}
